...
import { Route as AppNewClientRouteImport } from './routes/app/new-client'
...
const AppNewClientRoute = AppNewClientRouteImport.update({
  id: '/new-client',
  path: '/new-client',
  getParentRoute: () => AppRouteRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/app/new-client': {
      id: '/app/new-client'
      path: '/new-client'
      fullPath: '/app/new-client'
      preLoaderRoute: typeof AppNewClientRouteImport
      parentRoute: typeof AppRouteRoute
    }
    '/app/invoices': {
      id: '/app/invoices'
