...
import { greenleafInvoices } from './invoices'
...
Best regards,
GreenLeaf Consulting Collections Team`
}
...
function generateCommunicationsForInvoice(
  invoice: typeof greenleafInvoices[0],
  prefix: string
): Communication[] {
...
export const greenleafCommunications: Communication[] = greenleafInvoices.flatMap((invoice) =>
  generateCommunicationsForInvoice(invoice, 'gl')
)
